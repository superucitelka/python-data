...
engine = create_engine('mysql://root:@localhost/python?charset=utf8mb4', encoding='utf-8', echo=True, convert_unicode=True)

# Dotaz odstraní tabulku stat, pokud už existuje
engine.execute("DROP TABLE IF EXISTS `stat`")

# Vytvoření datového formátu z CSV souboru pomocí modulu pandas
...
# Vytvoření datového formátu z databáze na základě SQL dotazu
...
# Vytvoření jiného datového formátu z databáze na základě SQL dotazu
